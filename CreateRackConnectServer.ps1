...
$obj = @{
        server = @{
                ...
                "networks" = @(
                    @{
                        #RackConnect v3 ID change below to match your network ID, below is made up
                        "uuid" ="1234a4ac-1fe7-324e-bde9-2192299cde95"
                     }
                    @{
                        #This is the ID for ServiceNet
                        "uuid" ="11111111-1111-1111-1111-111111111111"
                     }
                     <#
                      @{
                        #This is the ID for PublicNet Not Needed for Rackconnect v3
